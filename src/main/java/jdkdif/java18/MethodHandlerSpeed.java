...
public class MethodHandlerSpeed {
    ...
    static {
        try {
            staticMethodConst = staticMethodVar = MethodHandlerSpeed.class.getDeclaredMethod("sumStatic", Integer.class, Integer.class);
            instanceMethodConst = instanceMethodVar = MethodHandlerSpeed.class.getDeclaredMethod("sumInstance", Integer.class, Integer.class);

            staticFieldConst = staticFieldVar = MethodHandlerSpeed.class.getDeclaredField("staticField");
            instanceFieldConst = instanceFieldVar = MethodHandlerSpeed.class.getDeclaredField("instanceField");
    ...
    public void setup() {
        ...
        if (polluteProfile) {
            try {
                Constructor ctor = MethodHandlerSpeed.class.getDeclaredConstructor(Integer.class);
                Method test1 = MethodHandlerSpeed.class.getDeclaredMethod("test1", Object.class);
                Method test2 = MethodHandlerSpeed.class.getDeclaredMethod("test2", Object.class, Object.class);
                Field f = MethodHandlerSpeed.class.getDeclaredField("testField");
    ...
    public MethodHandlerSpeed() {}

    // used for polluting the profile
    private MethodHandlerSpeed(Integer a) {}
